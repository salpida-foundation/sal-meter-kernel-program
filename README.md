...
The program sequence should be read in this order:
...
It does not create Sal-Meter validation, CAIS compliance, certification, or device designation.

---

### 2. I₃⁻ / Aptamer G-Iodine development inquiry

For aptamer, molecular interface, biosensor, or binding-characterization groups.
...
It is not a drug, diagnostic, treatment, or clinical-use track.
